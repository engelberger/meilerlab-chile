...
remove_duplicate_descriptor_files ./models/D4.updated.ready.rand.100_iter.1x32_005_025
run_merge_command /home/ben/workspace/bcl/build/linux64_release/bin/bcl-apps-static.exe model:PredictionMerge  -input_model_storage 'File(directory=./models/D4.updated.ready.rand.100_iter.1x32_005_025,prefix="model")'  -output ./results/D4.updated.ready.rand.100_iter.1x32_005_025/independent0-4_monitoring0-4_number0.gz.txt  -logger File ./log_files/D4.updated.ready.rand.100_iter.1x32_005_025/log_merge.txt  -opencl Disable 
